...
layout = [[ sg.Text('Tree Test') ],
          [ sg.Tree(data=treedata, headings=['col1', 'col2', 'col3', 'col4', 'col5', 'col6', 'col7', 'col8', 'col9'],justification='right',change_submits=True, auto_size_columns=True, num_rows=10, col0_width=10, key='_TREE_', show_expanded=True),
            ],
